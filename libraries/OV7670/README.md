OV7670 (no-FIFO) driver for ESP32
...
Usage:
- Copy the `OV7670` folder into your Arduino `libraries/` folder or include it in a project workspace under `libraries/OV7670`.
- Include `OV7670.h` in your sketch and instantiate the camera as shown in the example sketch in the repository root.
